...
class AppColors {
  ...
  /// General category - Neutral blue
  static const Color categoryGeneral = Color(0xFF6366F1);
  static const Color categoryGeneralLight = Color(0xFFE0E7FF);

  /// Study category - Purple
  static const Color categoryStudy = Color(0xFF8B5CF6);
  static const Color categoryStudyLight = Color(0xFFEDE9FE);

  /// Assignment category - Orange
  static const Color categoryAssignment = Color(0xFFF97316);
  static const Color categoryAssignmentLight = Color(0xFFFFEDD5);

  /// Exam category - Red
  static const Color categoryExam = Color(0xFFDC2626);
  static const Color categoryExamLight = Color(0xFFFEE2E2);

  /// Project category - Teal
  static const Color categoryProject = Color(0xFF14B8A6);
  static const Color categoryProjectLight = Color(0xFFCCFBF1);

  /// Personal category - Pink
